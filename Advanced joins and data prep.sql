...
WITH 
		...
		(SELECT SNAPSHOT_DAY, 
				...
				head_item_gaps,
		CASE 
		WHEN gl_product_grp = '504 - Home Entertainment' THEN 'CA Home Entertainment'
		WHEN gl_product_grp = '198 - Luggage' THEN 'CA Luggage'
		WHEN gl_product_grp = '229 - Office Products' THEN 'CA Office Products'
		WHEN gl_product_grp = '328 - Biss' THEN 'CA BISS'
		WHEN gl_product_grp = '21 - Toys' THEN 'CA Toys'
		WHEN gl_product_grp = '325 - Grocery' THEN 'CA Grocery'
		WHEN gl_product_grp = '194 - Beauty' THEN 'CA Beauty'
		WHEN gl_product_grp = '267 - Musical Instruments' THEN 'CA Musical Instruments'
		WHEN gl_product_grp = '263 - Automotive' THEN 'CA Automotive'
		WHEN gl_product_grp = '469 - Tools' THEN 'CA Tools'
		WHEN gl_product_grp = '147 - PC' THEN 'CA Personal Computer'
		WHEN gl_product_grp = '201 - Home' THEN 'CA Home'
		WHEN gl_product_grp = '23 - Electronics' THEN 'CA Consumer Electronics'
		WHEN gl_product_grp = '309 - Shoes' THEN 'CA Shoes'
		WHEN gl_product_grp = '79 - Kitchen' THEN 'CA Kitchen'
		WHEN gl_product_grp = '121 - Health & Personal Care' THEN 'CA Health and Personal Care'
		WHEN gl_product_grp = '200 - Sports' THEN 'CA Sporting Goods'
		WHEN gl_product_grp = '86 - Lawn and Garden' THEN 'CA Lawn and Garden'
		WHEN gl_product_grp = '75 - Baby' THEN 'CA Baby'
		WHEN gl_product_grp = '199 - Pet Products' THEN 'CA Pets'
		WHEN gl_product_grp = '196 - Furniture' THEN 'CA Furniture'
		WHEN gl_product_grp = '60 - Home Improvement' THEN 'CA Home Improvement'
		WHEN gl_product_grp = '107 - Wireless' THEN 'CA Wireless'
		WHEN gl_product_grp = '193 - Apparel' THEN 'CA Apparel'
		WHEN gl_product_grp = '510 - Luxury Beauty' THEN 'CA Luxury Beauty'
		WHEN gl_product_grp = '468 - Outdoors' THEN 'CA Outdoors'
		WHEN gl_product_grp = '265 - Major Appliances' THEN 'CA Large Appliances'
		WHEN gl_product_grp = '421 - Camera' THEN 'CA Camera'
		WHEN gl_product_grp = '241 - Watches' THEN 'CA Watches'
		WHEN gl_product_grp = '197 - Jewelry' THEN 'CA Jewelry'
		WHEN gl_product_grp = '293 - Tires' THEN 'CA Tires'
		WHEN gl_product_grp = '364 - Personal_Care_Appliances' THEN 'CA Personal Care Appliances'
		WHEN gl_product_grp = '63 - Video Games' THEN 'CA Video Games'
		WHEN gl_product_grp = '422 - Mobile_Electronics' THEN 'CA Consumer Electronics'
